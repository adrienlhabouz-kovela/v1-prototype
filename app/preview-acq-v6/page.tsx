...
// ─── /preview-acq-v6 — pack world-class V6 ───────────────────────────────
// Refonte basée sur :
//   - Rapport d'état de l'art (sources : Unbounce SaaS report, Navattic
//     Interactive Demo 2025, Chili Piper benchmark, NN/g, Brixon,
//     Demand Curve, Harry Dry, Pixeldarts, Desigeist, Caffeine Marketing).
//   - Teardown de 12 landings live (Linear, Stripe, Vercel /enterprise,
//     Notion Business, Ramp, Mercury, Attio, Cal.com, Doctolib Pro,
//     Resilience, Lifen, Curecall, Anthropic, Figma Enterprise).
//
// Décisions stratégiques utilisateur :
//   - Témoignages chirurgiens : anonymisés (« 17 chirurgiens consultés »)
//   - Pas d'embed Calendly (LeadForm mailto + promesse Adrien 24h)
//   - Pas de scarcité (les 10 premiers cab ne viendront pas du web)
//   - H1 manifesto exploitant l'insight « le silence = futur addiction »
//   - Registre : institutionnel premium (Anthropic + Resilience) plutôt
//     que performance acquisition pure — la landing sert de 2e œil
//     après bouche-à-oreille, pas de funnel automatisé.
...
// ─── Page ─────────────────────────────────────────────────────────────────
export default function PreviewAcqV6() {
  return (
